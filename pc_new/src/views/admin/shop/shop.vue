    ...
    <el-form ref="form" :model="form" label-width="100px">
      ...
      <el-form-item label="短视频">
        <el-upload
          ...
          :action="$axios.defaults.baseURL + 'User/upload_video'"
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      var actions = "Workbench/addShop/";
      if (this.shopid > 0) {
        actions = "Workbench/updateShop/";
      }
