	...
	<view class="content">
		...
		<view class="search">
			<view class="nav_search">
				<input type="text" confirm-type="send" maxlength="-1" @confirm="formSubmit" placeholder="搜索你想要的商家"
					placeholder-class="nav_searchs" :style="{'margin-top': ((height+10)*2)+'rpx'}" />
			</view>
		</view>
		<view style="position: relative;">
			<image src="../../static/icon/public/2.png" mode="aspectFill" v-if="type==1" class="shopimg"></image>
			<image src="../../static/icon/public/3.png" mode="aspectFill" v-else-if="type==2" class="shopimg"></image>
			<image src="../../static/icon/public/4.png" mode="aspectFill" v-else-if="type==3" class="shopimg"></image>
			<image src="../../static/icon/public/5.png" mode="aspectFill" v-else-if="type==4" class="shopimg"></image>
			<image src="../../static/icon/public/1.png" mode="aspectFill" v-else class="shopimg"></image>
			<view v-if="type<0" class="home_tongji_txt">
				<view style="margin-left: 130rpx;width: 85rpx;"><text v-for="(item,index) in tongji_list.add_shop" :key="index">{{item}}</text></view>
				<view style="margin-left: 105rpx;width: 70rpx;"><text v-for="(item,index) in tongji_list.cell_daren" :key="index">{{item}}</text></view>
				<view style="margin-left: 110rpx;"><text v-for="(item,index) in tongji_list.cell_brand" :key="index">{{item}}</text></view>
			</view>
		</view>
		...
		<view class="shop_condition">
			<view class="shop_condition_list_l">
				<view class="shop_condition_list" @tap="binCondition(1)">
					最新
					<image src="../../static/icon/public/jt_bottom.png" mode="aspectFill"
						class="shop_condition_list_l_image">
				</view>
				<view class="shop_condition_list" @tap="binCondition(2)">
					销量
					<image src="../../static/icon/public/jt_bottom.png" mode="aspectFill"
						class="shop_condition_list_l_image">
				</view>
				<view class="shop_condition_list" @tap="binCondition(3)">
					佣金
					<image src="../../static/icon/public/jt_bottom.png" mode="aspectFill"
						class="shop_condition_list_l_image">
				</view>
		...
		<view class="shop_main">
			<view class="shop_list" v-for="(item,index) in shop_list" :key="index">
				<view class="shop_info_t">
					<image :src="item.logo" mode="aspectFill" class="shop_pic" @tap="ShopInfo(item.id)"></image>
				...
				<!-- <view class="shop_key">
					店铺关键词:
					<view v-for="(item2,index) in item.keywords" :key="index" class="shop_key_list">
						{{item2}}
					</view>
				</view> -->
